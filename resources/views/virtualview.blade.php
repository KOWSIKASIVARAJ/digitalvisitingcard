        ...
        <div class="container">
            <div class="row justify-content-center ms-5 ps-lg-0 ps-md-0 ps-5 mt-xl-5 mt-lg-3 mt-md-3 mt-0 mb-4 d-flex flex-wrap-reverse" >
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 mt-5">
                    ...
                    <p id="we" class="mt-4">Easy to share your details over this virtual background cards..</p>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 mt-4">
                    <img src="public\images\cards\v-bg-1.png" alt="mobile" class="w-100 mt-xl-5 mt-lg-3 mt-md-0 mt-0 mb-lg-5 mb-md-5 mb-0">
                    <p class="mb-3"></p>
                </div>
            </div>
        </div>

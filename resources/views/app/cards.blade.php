   ...
   <body >
      ...
      <div class="container-fluid home-section">
                  ...
                  <div class="row justify-content-center ">
                     <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                        <div class="justify-content-start my-2 d-flex">
                           <a href="{{url('home')}}"><img src="public\images\add\ph_arrow-left-bold.png" alt="" class="ms-2"></a>
                              ...
                              <div class="modal-content">
                                 ...
                                 <div class="row justify-content-center">
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-5 mt-4">
                                       <img src="public\images\settings\amico.png" alt="">
                                    </div>
                     ...
                     <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                        <div class="text-center my-2">
                           <button type="button" href="" class="wel-4 btn-btn py-1 mt-xs-4 add-card-parent ms-3">
                              <h6 class="mx-3 my-1" style="color: white;">Add Card</h6>
                           </button>
                        </div>
                     </div>
                  </div>
         ...
         <div class="row justify-content-center mt-5 ms-lg-3 ms-md-0 ms-5 mb-5">
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3 my-3 ms-3">
               <div class="card my-2 text-center" id="card-1">
                  <div class="card-title mx-auto d-flex mt-3">
                     <h5 class="card-tit mt-1">Cards</h5>
                     <a href=""><i class="bi bi-plus-circle fs-3 mx-2" style="color:black"></i></a>
                  </div>
                  <h6 class="card-bp my-3 map-point-sm" data-bs-toggle="tab" data-show=".business">Business</h6>
                  <h6 class="card-bp my-3 map-point-sm" data-bs-toggle="tab" data-show=".personal">Personal</h6>
                  <h6 class="card-bw my-2 me-4 mb-5 map-point-sm" data-show=".work">Work</h6>
               </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 text-center ms-lg-3 ms-md-0 ms-3 mb-5">
               <div class="card my-4" id="card-2">
                  <div class="map-container">
                     <div class="inner-basic division-map div-toggle" data-target=".division-details" id="divisiondetail">
                        <div class="row justify-content-start">
                           <div class="col-xs-12 col-sm-12 col-md-5 col-lg-4 mt-3">
                  ...
                  <div class="map-container ">
                     <div class="business">
                        <div class="row justify-content-evenly my-4 darwin  initialmsg">
                           <div class="col-xs-12 col-sm-12 col-md-10 col-lg-7">
                              <div class="card" id="card-3">
                                 <img src="public\images\color\lg-wave-blue.png" alt="">
                                 <img src="public\images\add\Rectangle 2080.png" alt="" class="whitewave">
                                 <img src="public\images\cards\Mask group.png" alt="" class="whitewave">
                                 <div class="text-start ms-4 my-3">
                                    <h5 class="nme">Praveen</h5>
                                    <h6 class="rle">Darwin Travel </h6>
                                 </div>
                                 <div class="row justify-content-center">
                                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                       <div class="wp-num d-flex mx-1">
                                          <div class="row">
                                             ...
                                             <div class="col-8">
                                                <h6 class="num mt-3">7010805798</h6>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="wp-num d-flex mx-1 my-3">
                                          <div class="row">
                                             ...
                                             <div class="col-9">
                                                <h6 class="num mt-3">praveen3@gmail.com</h6>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="wp-num d-flex mx-1 mb-3">
                                          <div class="row">
                                             ...
                                             <div class="col-8">
                                                <h6 class="num mt-3">Make a call</h6>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                           ...
                           <div class="col-xs-5 col-sm-5 col-md-7 col-lg-7">
                              <div class="card ms-5" id="card-3">
                                 <div class="tab-content">
                                       ...
                                       <div class="card" style="border: none;">
                                          ...
                                          <div class="card-body">
                                             <div class="text-center my-1">
                                                <div class="row justify-content-center">
                                                   <img class="img-thumbnail w-75 border-0" src="public\images\cards\qr-code.png" alt="">
                                                </div>
                                    ...
                                    <div id="menu2" class="container tab-pane fade w-100">
                                       <br>
                                       <div class="card" style="border: none">
                                          <div class="card-title text-center">
                                             <h3 class="nme mt-4">Send Card</h3>
                                    ...
                                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                                       ...
                                       <div class="wp-num d-flex mx-1 my-3">
                                          <div class="row">
                                             ...
                                             <div class="col-9">
                                                <h6 class="num mt-3">thivinn3@gmail.com</h6>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="wp-num d-flex mx-1 mb-3">

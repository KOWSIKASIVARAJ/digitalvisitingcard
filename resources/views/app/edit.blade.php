    ...
    <div class="home-section">
      <div class="container ">
              ...
              <div class="col-xs-12 col-sm-12 col-md-10 col-lg-6">
                <div class="row justify-content-center">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 mt-3">
                        <button id="head-btn" class="me-lg-3 me-5">Cancel</button>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 mt-3">
                        <button  class=" me-lg-3 me-5"  id="head-btn" >Save Changes</button>
                    </div>
                </div>
              </div>
            </div>
        ...
        <div class="row justify-content-center mt-5 ms-lg-3 ms-md-0 ms-5 mb-5">
          <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mb-5 text-start">
          ...
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-7">
            ...
            <div class="row  ms-xl-2 ms-lg-5 ms-md-3 ms-4 mt-3 mx-2 mt-3" id="img-card">
              ...
              <div class="row justify-content-evenly ms-1 mb-3 "  style="gap: 8px;">
            ...
            <div class="row justify-conter-center  ms-xl-2 ms-lg-5 ms-md-3 ms-4 mt-3 mx-2 mt-3" id="color-box">
              ...
              <div id="switcher" class="space classic small-images mb-3 mt-3 d-flex" style="overflow-x: scroll; overflow-y: hidden; padding-left: 0%">
                <img src="public\images\color\Ellipse 698.png" alt="" class="ms-5 mt-2" style="width: 37px;height: 37px;">
                <img
            ...
            <div class="row ms-xl-2 ms-lg-5 ms-md-3 ms-3 mx-1 mt-3 mb-5" id="social-body">
                     ...
                     <div class="row justify-content-evenly mb-3" style="gap: 3px;">
